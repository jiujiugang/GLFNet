...
class StarNet(nn.Module):
    def __init__(self, base_dim=256, depths=[3, 2,3], mlp_ratio=4, drop_path_rate=0.0, **kwargs):
        super().__init__()
...
class FusionModel(nn.Module):
    def __init__(self, num_classes=5):
        ...
        self.StarNet = StarNet(base_dim=256, depths=[3, 4, 6], mlp_ratio=4, drop_path_rate=0.0)
        self.HTnet = HTNet(
            image_size=28,
            patch_size=7,
            dim=256,
